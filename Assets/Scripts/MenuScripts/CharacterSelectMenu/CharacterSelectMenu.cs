...
public class CharacterSelectMenu : MonoBehaviour 
{
    ...
    public int Player1SelectedButtonIndex
    {
        set
        {
            characterSelectButtonArray[player1SelectedButtonIndex].UnselectButton(Player.PLAYER1_NUMBER);
            player1SelectedButtonIndex = value;
            characterSelectButtonArray[player1SelectedButtonIndex].SelectButton(Player.PLAYER1_NUMBER);
        }
        get
        {
            return player1SelectedButtonIndex;
        }
    }
    public int Player2SelectedButtonIndex
    {
        set
        {
            characterSelectButtonArray[player2SelectedButtonIndex].UnselectButton(Player.PLAYER2_NUMBER);
            player2SelectedButtonIndex = value;
            characterSelectButtonArray[player2SelectedButtonIndex].SelectButton(Player.PLAYER2_NUMBER);
        }
        get
        {
            return player2SelectedButtonIndex;
        }
    }
    ...
    {
        if (Input.GetKeyDown(KeyCode.S) && Player1SelectedButtonIndex < characterSelectButtonArray.Length - gridLayoutGroup.constraintCount)
        {
        ...
        {
            characterSelectButtonArray[player1SelectedButtonIndex].SelectCharacter(Player.PLAYER1_NUMBER);
        }
    }
    private void Player2SelectCharacterInput()
    {
        if (Input.GetKeyDown(KeyCode.DownArrow) && Player2SelectedButtonIndex < characterSelectButtonArray.Length - gridLayoutGroup.constraintCount)
        {
        ...
        {
            characterSelectButtonArray[Player2SelectedButtonIndex].SelectCharacter(Player.PLAYER2_NUMBER);
        }
    }
