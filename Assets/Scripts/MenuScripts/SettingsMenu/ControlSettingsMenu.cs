...
//Переделать меню настроек контролов ,два столбца леблы названия кнопок справла - слева считываение кнопки с клавиши , внизу отдельная кнопка для сохранения результата
class ControlSettingsMenu : MonoBehaviour
{
    //path to saved file = C:\Users\tokur\AppData\LocalLow\DefaultCompany\FightingTest

    [SerializeField]
    private GameObject[] player1ButtonsArray;
    [SerializeField]
    private GameObject[] player2ButtonsArray;
    ...
    [SerializeField]
    private GameObject player1MenuController;
    [SerializeField]
    private GameObject player2MenuController;
