...
public class RedBotComboList : ComboHandler
{
    ...
    public override void InitializeComboList()
    {
        ...
        ComboAttacksList[0].ControlsList = new KeyCode[4]
        {
            playerControls.MoveBackward, playerControls.Crouch, playerControls.MoveForward, playerControls.Punch
        }; //Left Down Right P
        ComboAttacksList[1].Name = "Combo2";
        ComboAttacksList[1].Damage = 10;
        ComboAttacksList[1].ControlsList = new KeyCode[3]
            {playerControls.Crouch, playerControls.MoveBackward, playerControls.Punch}; // Down Left P
    }
}