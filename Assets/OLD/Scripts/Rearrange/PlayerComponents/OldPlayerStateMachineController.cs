...
namespace OLD.Scripts.Rearrange.PlayerComponents
{
    public class OldPlayerStateMachineController : MonoBehaviour, IPlayerComponent
    {
        ...
        public void InitializeComponent(PlayerModel playerModel)
        {
            ...
            playerStates.Idle = new Idle(playerModel, PlayerStateMachineOld, animator, playerRigidbody, playerControls,
                transform);
            playerStates.Crouch =
                new Crouch(playerModel, PlayerStateMachineOld, animator, playerRigidbody, playerControls, transform);
            playerStates.RunForward =
                new RunForward(playerModel, PlayerStateMachineOld, animator, playerRigidbody, playerControls,
                    transform);
            playerStates.RunBackward =
                new RunBackward(playerModel, PlayerStateMachineOld, animator, playerRigidbody, playerControls,
                    transform);
            playerStates.Jump = new Jump(playerModel, PlayerStateMachineOld, animator, playerRigidbody, playerControls,
                transform);
            playerStates.Fall = new Fall(playerModel, PlayerStateMachineOld, animator, playerRigidbody, playerControls,
                transform);
            playerStates.Block =
                new Block(playerModel, PlayerStateMachineOld, animator, playerRigidbody, playerControls);
            playerStates.Punch =
                new Punch(playerModel, PlayerStateMachineOld, animator, playerRigidbody, playerControls);
            playerStates.Kick = new Kick(playerModel, PlayerStateMachineOld, animator, playerRigidbody, playerControls);
            playerStates.Combo =
                new Combo(playerModel, PlayerStateMachineOld, animator, playerRigidbody, playerControls);
            playerStates.Death =
                new Death(playerModel, PlayerStateMachineOld, animator, playerRigidbody, playerControls);
